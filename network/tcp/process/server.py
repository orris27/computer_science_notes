'''
    ...
    !!Important: Main process should close client_socket
    1. create a socket
...
with socket.socket(socket.AF_INET,socket.SOCK_STREAM) as s:
    ...
    while True:
        ...
        t = multiprocessing.Process(target=handle_client,args=(client_socket,client_addr))
        t.start()

        client_socket.close() # !!important 
