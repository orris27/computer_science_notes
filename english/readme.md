...
60. chorus: 可乐 + 床褥 => 天空中有一个床褥,然后合唱队的人下面唱歌,床褥摇一下就会掉下一瓶可乐

61. chord: 可乐 + d => 可乐放入勺子,里面的线将可乐取出来给我喝(喝线)

62. harp: 蛤蟆 + 爬 => 蛤蟆爬竖琴,结果一直竖着往上爬了很多

63. trumpet: 船 + 皮卡丘 => 船上有一个皮卡丘,它叫上小号一起发电

64. rehearsal: rehearse => 排练 => 排练

65. pitch: 皮卡丘 + 弯曲 => 皮卡丘弯曲,变高了(音高)

66. organ: 器官 => 器官被风吹走了,结果很轻(风琴)

67. allude: apple + 路 + 球网 => 苹果掉在路上,划过球网,暗牧(语文,类似allusive引用典故,allude暗指)


68. pedagogic: 胖太 + 咕咕 + 巨大 => 胖太咕咕地叫出来,巨大的"咕"出现了,挠痒天神的脚,将血清空(教学法的)

69. illusion: 椅子 + 路上 + 齐神 => 椅子在路上滑行,撞到了齐神,摔倒前想到了心美的幻觉

70. ragtime: rag + 手表 => 用rag覆盖住手表,然后里面出现音乐 => 音乐style之一 => 格拉坦姆

71. symphony: 大海 + phone => 大海里有一个电话,这个电话用脚快乐地走路(交响乐)


72. harpsichord: 蛤蟆 + 大海 + 可乐 => 蛤蟆用舌头卷起大海,然后变化成可乐,最后将很大的海水喝了进去,眼里很贱

73. banjo: 搬砖 => 搬砖之余拉班卓琴

74. clarinet: clear + network(Ubuntu右上角的标签) => 标签没清除没了,一个子弹恢复回来,变黄色了

75. vinyl: 比克提尼 + 泥巴 => 比克提尼在泥巴里玩耍结果弄黑了自己(黑胶唱片)

76. audition: 齐神 => 试演的时候齐神也在

77. acrobatic: acre + battle => 在很大的田地上战斗,杂技演员刷球,从天而降的球进行攻击

78. pantomime: 胖 + 头 + 埋 => 梦原很胖的头,结果埋在地下,发不出声音

79. choir: 可乐 + 外星人 => 可乐被外星人抢走了,大家组成队伍,开始合唱,外星人流泪还了回来

80. glissando: 给力 + 三 + "咚" => 给力的臂膀变成三个,结果将自动售货机咚地,呸,自己滑倒了

81. bass: 巴士 => 巴士变低,超音速前行
...
94. (adj)deft: 球门 + 福特汽车 => 汽车冲向球门,然后球门烤熟了(熟练的)

95. (adj)adept: adapt + e(鱼) => 鱼在新的水池里,适应后进化变长了
...
99. (n)aptitude: attitude(态度 => 青叶的捏脸) + apple => 青叶捏脸,然后出现苹果,这个苹果变成了人偶熊(象征这青叶被八神认可的才能)

100. (n)vigor: 刺猬 + goal => 刺猬冲过goal,结果sj了

101. (n)caliber: 咖喱棒 => 用咖喱棒开瓶子(品质)的盖子

102. (n)temperament: 温度计 + 门 => 大温度计举起旗子(气质),旅游团,门开了

103. (n)disposition: 笛子 + position => 笛子放在明显的位置上,然后这个位置上星星飞了过来,带走它,变成晴天 => 星星 + 晴天 => 性情

104. (adj)avid: av + 勺子 => 用很大的勺子拿出所有av,贪婪的

105. (adj)ravenous: 拉姆 + 脑 => 我全都要,抓住拉姆,结果握紧后只剩下脑袋

106. (adj)avarice: 阿凡提(驴子) + ride(骑着) + 屎 =>我全都要,阿凡提骑着驴子踩在手上,然后拉出屎后就走了

107. (adj)rapacious: ray + 坡 + 手势 => ray冲破了,比划着手势,推开了"我全都要"的手

108. (adj)covetous: cover + 莲藕 => 我全都要,手里cover着一块布,掀开后是一个莲藕,拧紧后有汁液

109. (adj)acquisitive: acquire + 石头 + 踢 => 我全都要,结果获得了石头,石头变成钻石,另一个人踢开了

110. (adj)ascetic: 纳爱斯牙膏 + 蛇 + 梯子 => 纳爱斯中出来蛇形状的牙膏,然后蛇爬梯子,暴雪,结冰,苦行啊

111. (n)rigor: 太阳照射到球网,将球网弄成格子状态(严格) (vigor=>精力)

112. (adj)intrepid: 老鹰 + 车子 + 皮卡丘 => 老鹰停在车子上,然后皮卡丘放电,本来老鹰会只剩下骨头的,但是没有效果,老鹰说"你很勇啊"

113. (adj)gallant: gay + ant => 比利王在英国国旗上和蚂蚁摔跤,蚂蚁很勇敢

114. (adj)valiant: 刺猬 + 篱笆 + ant => 刺猬穿过篱笆,看到蚂蚁,蚂蚁英勇地提出来挑战,然后他们就单挑了

115. (adj)ruthless: 床褥 + 石头 + 蕾丝 => 床褥上掉下来石头,弹了一下,然后石头穿起了蕾丝,一个无脸部器官(无情)的人在石头上面摩擦


116. (adj)snobbish: snow + 笔 + 嘘嘘 => 下雪了,形成笔,嘘嘘,发现变成黄金,势利的那个人直接偷走了

117. (adj)undaunted: 按钮 + 洞 + 梯子 => 一个按钮按下去,出现一个洞,这个洞里球踢了出来,卫宫(无畏的)出来了

118. (adj)dauntless: undaunted(无畏的) + less(无) => 无畏的


119. (adj)flighty: flight + y => 飞机上y神膨胀了,轻浮了起来


120. (adj)skimpy: ski + 皮卡丘 => 皮卡丘滑雪,发现绿色的凛(凛色 => 吝啬),刮起雪走了

121. (adj)stingy: sting(蚊子) + y => 蚊子的针做出y的形状,然后攻击了绿色的凛,毫无作用

122. (adj)bold: 粗体字 => 粗体字变得很大 => 大胆的

123. (adj)daring: darling - l(出轨) => 对亲爱的出轨,所以很大胆

124. (n)valor: 刺猬 + 楼 => 刺猬爬楼,黑暗的,刺猬骨气勇气就上去了

125. (adj)exacting: 准确的,准确的,准确的,... => 过度准确 => 太严格了! 

126. (adj)grim: green + 汉堡 => 给伦戴上绿色的汉堡,现实太残酷了

127. (adj)relentless: 热 + 冷 + 蕾丝 => 从很热的地方过来结果又很冷,器官都绝望地消失了,然后看见很多人穿着蕾丝,就又回来了

128. (adj)rigid: 太阳 + 锯子 + 大地 => 太阳上一个锯子掉了下来,然后大地炸成了格子

129. (adj)stern: stone + 摁住 => 将石头摁住,然后石头形成格子,爆裂了

130. (adj)stringent: string + 摁住 => 将字符串摁住,扔回方格纸里


131. (adj)drastic: dress + tick => 老太婆穿着dress,然后拐杖,敲了下拐杖,变得很严格

132. (adj)rigorous: rigor + ous(形容词) => 严格的

133. (n)ordeal: 莲藕 + deal(贵重的 => 重的) => 将莲藕放到称重机上,然后很重,显示屏上出现裤子,结果裤子跑了出来(严酷的考验)

134. (adj)incisive: 老鹰 + 大海 + save => 老鹰在大海上漫游,深水,掉下去,直升飞机绳子救了鹰

135. (adj)spontaneous: spoon + 弹 + 莲藕 => 勺子上的莲藕抖了一下,然后弹到了紫发美少女上(自发的)

136. (n)beet: bee + t舞台 => 蜜蜂在t舞台上舔菜

137. (adj)instinctive: 老鹰 + sting(蚊子) + 踢 => 老鹰和蚊子争斗,结果老鹰将蚊子踢上天(天生的)

138. (adj)innate: 老鹰 + 柰子 => 老鹰的柰子是绳子,从天上垂下来,大家以为是天绳

139. (adj)rudimentary: 床褥 + 地 + mantle => 床褥掉到了地上,然后突然冲到了地幔里,结果变成了根本的原材料


140. (n)condiment: 空调 + 地 + 门 => 空调掉到了地上,然后冲到门,结果胃跳了出来(调味品)

141. (n)seasoning: 四季 + 老鹰 => 四季的照片加上老鹰,印刻在调味品上,摇出雪球,枫叶等

142. (n)spinach: spin(旋转 => 旋转的圆盘) + archer => archer在圆盘上转,结果柰子给弄大了(波波)

143. (n)bland: 笔 + land(着陆) => 笔从空中着陆,里面的乌鸦刺激死了(无刺激的)

144. (n)radish: ray + dish => ray吃的餐里面是大萝卜,然后吃起来

145. (n)edible: 艾迪(杀天里的南瓜) + ball => 艾迪将自己的头当球吃了(可食的)

146. (n)imbibe: 一百块钱 => 一百买了很多饮品(饮)

147. (n)celery: 厕所 + 可乐 + 雷 => 厕所跑出可乐,雷劈下来,用竹蜻蜓逃走了(芹菜)

148. (n)leek: leak => 船里泄露出了醉的鱼,喝酒喝多了(韭菜)

149. (n)rye: ray + 叶子 => ray用叶子遮住眼睛,结果叶子变黑了(黑麦)

150. (n)millet: 米粒 => 大米变成颗粒,颗粒变成栗子,然后碰撞

151. (n)mustard: master =>　士郎见到saber后叫了声姐姐(芥末)

152. (n)oats: 莲藕 + 石头 => 莲藕套住石头,然后摩擦出燕麦片

153. (n)pea: 放屁 => 放屁放出来豌豆

154. (n)peanut(花生)

155. (n)pepper: paper => 在纸上撒胡椒粉,然后就能闻到气味

156. (n)sesame: 蛇 + same => 很多相同的蛇在罐子里,和芝麻一起摇

157. (n)cuisine: 吹 + sin => 吹一下sin图像,然后变成了烹调的形状

158. (n)beverage: bear + age(老) => 熊老了,轻轻踢售货机,出来快乐水

159. (n)nutriment: 牛 + 吹 + 门 => 牛吹了门,然后掉下来牛奶这个营养品

160. (v)nibble: 泥巴 + ball => 泥巴用细咬的姿势细咬球

161. (n)barley: 浴霸 + 雷电 => 用浴霸释放雷电,变大了,结果炸了五舍,埋了(大麦)

162. (adj)indigenous: 硬币 + genius(天才 => 空助) => 空助咬硬币,固定(固有的)住了,咬不碎

163. (adj)radical: ray + 地 + 可乐 => ray趴在地上听,快乐水喷出来了,ray扎根
...
2. noun
    ...
    ```
    17. franchise: friend + cheese => 朋友切开比我们都大的起司,这是他的特权
    18. banter: 棒 + 塔 => 夜斗(无恶意的玩笑)拿着一个棒锤一个塔,然后开心地出现猫眼
    19. bliss: 比利 + 蛇 => 比利对着蛇摩擦,比利看起来处在极乐的状态
    20. mundane: 盲人 + 电线 => 一个巨大的盲人用拐杖碰了一下电线,结果这个电线放出了灰色的螺旋,将盲人引入了另一个世界(世俗的,世界的)
    21. lore: 楼 => 这座楼里的书本(知识)都要溢出了
    22. juggernaut: jungle + 脑 => 丛林里的树木被赋予了大脑,然后就开始不断商量之后增殖了起来,甚至在海洋上开拓了自己的疆域,真的是世界主宰
    23. mage: 草莓 + 锯子 => 士郎用使用魔法用锯子将草莓切了下来,然后用魔法吃下了这些草莓.士郎是魔术师
    24. spinoff(续集)
    25. boob
    26. vibe: 外星人 + 笔 => 外星人用笔将自己周围的空气(气氛)给凝固了起来
    27. ideology: idea(大脑) + 老酒 => 学习(玩耍)累了,就将自己的大脑放到老酒里泡一下,然后大脑就被新的仪式形态给充溢着,重新焕发了英姿
    28. epic: eye => 史诗图片的fate里的眼睛突然变得非常耀眼
    29. pander: panda => 大熊猫突然开始卖萌,用两只手指进行怂恿
    30. pathetic(可悲的)
    ...
    35. half-brother: 半个 + 兄弟 => 亲兄弟需要父母都相同,一半满足就是说父或者母的其中一个是不同的
